...
BEGIN
    ...
    FOR v_ID IN 1..v_NUMCLI LOOP
        ATUALIZAR__SEGMERCADO (v_ID, v_SEGMERCADO);
    END LOOP;    
END;
...
BEGIN
   ...
   EXCEPTION
    ...
    dbms_output.put_line('******** CLIENTE JÁ FOI CADASTRADO ********');
END;

-- TRATANDO O ERRO COM EXCEPTION DE FORMA MAIS ADEQUADA
create or replace NONEDITIONABLE PROCEDURE incluir_cliente
(
p_ID CLIENTE.ID%type,
p_RAZAO CLIENTE.RAZAO_SOCIAL%type,
...
BEGIN
   ...
   EXCEPTION
    WHEN DUP_VAL_ON_INDEX THEN
    -- PODEMOS IDENTIFICAR O ERRO COM OS NÚMEROS ENTRE -20000 E -20999
