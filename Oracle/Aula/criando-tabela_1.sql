...
-- SYSDATE É A DATA DO COMPUTADOR
...
-- ESTE MÉTODO REPLACE BUSCA DENTRO DO TEXTO O QUE GOSTARIA DE ALTERAR, REALIZANDO ASSIM A ANTERAÇÃO SOMENTE NO PEDAÇO DO TEXTO  
UPDATE PRODUTOS SET DESCRITOR = REPLACE(DESCRITOR, 'Manga', 'Laranja') WHERE CODIGO = '1040112';
-- AUMENTO DE 10% NOS ITENS COM SABOR MANGA
